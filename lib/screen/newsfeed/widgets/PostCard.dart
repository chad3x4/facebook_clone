...
import 'package:flutter_application_2/screen/editpost/EditPostPage.dart';
...
class PostCard extends StatefulWidget {
  final Post post;
  final bool isNFPost;
  const PostCard({super.key, required this.post, this.isNFPost = false});
    ...
    return Column(
      children: [
                          ...
                          children: [
                            ...
                            (widget.post.isModified!)
                                ? const Icon(Icons.edit,
                                    color: GlobalVariables.iconColor, size: 14)
                                : Container()
                          ],
                        ),
                      ],
        ...
        Material(
          ...
          child: InkWell(
            onTap: () async {
              var body = {'id': widget.post.postId, 'index': 0, 'count': 50};
              var response = await http.post(Uri.parse('$root/get_list_feels'),
                  headers: <String, String>{
                    'Content-Type': 'application/json',
                    'Authorization': token
                  },
                ...
                List<Feel> data =
                  ...
                  return Feel(
                    ...
                    user: User(
                      ...
                      avatar: (item['feel']['user']['avatar'] as String).isEmpty
                          ? defaultavt
        ...
        Row(
          ...
          children: [
            ...
            InkWell(
              onTap: () async {
                var body = {'id': widget.post.postId, 'index': 0, 'count': 10};
                var response = await http.post(
                      ...
                      comments: (item['comments'] as List<dynamic>)
                        ...
                        return Comment(
                          ...
                          user: User(
                            ...
                            avatar: (smallerItem['poster']['avatar'] as String)
                                    .isEmpty
                                ? defaultavt
